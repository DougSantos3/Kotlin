...
class Redis {
    /*
    Conhecemos o porquê do cache em memória não ser uma boa opção para ambientes produtivos. Sempre que fizer o deploy
    da aplicação, o cache será apagado, além de não ser escalável;
