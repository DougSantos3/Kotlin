...
public class Csrf {
    ...
    Ao entrar nesse site, no corpo dele, tem um formulário assim:
    ...
    A requisição forjada não é exatamente o problema, mas sim o fato de o seu navegador ter enviado junto com ela aquele
    cookie da autenticação e o site do seu banco achará que foi você quem solicitou a transferência.
